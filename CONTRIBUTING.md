# Contributing to Byndyusoft.Data.Relational.Specifications
...
If you want to fix, to add enhancement, or to improve documentation, you need to learn how to work with GitHub, Byndyusoft.Data.Relational.Specifications code base and contributing rules.
...
```shell
 git clone https://github.com/Byndyusoft/Byndyusoft.Data.Relational.Specifications.git
```
